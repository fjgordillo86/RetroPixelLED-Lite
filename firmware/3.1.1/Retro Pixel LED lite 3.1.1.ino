...
// ====================================================================
#define FIRMWARE_VERSION "3.1.1" // Mejoras en el Motor de ReplayOS. Se añade opcion de mostrar IP al Inicar el sistema. Descarga de Idiomas desde la APP. Se añade la opcion de confi APP y descarga de idiomas en el menu OSD. Fix conexión PWA y reconexión wifi en caso de perdida.
#define CURRENT_VERSION_NUM 311 // Versión numérica para comparar (2.1.0 -> 210)
